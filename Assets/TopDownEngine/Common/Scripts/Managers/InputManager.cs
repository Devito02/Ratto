...
{	
	...
	public class InputManager : MMSingleton<InputManager>
	{
        ...
        /// the shoot button
        public virtual MMInput.IMButton SuckButton { get; protected set; }
        /// the reload button
		...
		protected virtual void InitializeButtons()
		{
			...
			ButtonList.Add(SuckButton = new MMInput.IMButton(PlayerID, "Suck", SuckButtonDown, SuckButtonPressed, SuckButtonUp));
        ...
        public virtual void SuckButtonDown() { SuckButton.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
        public virtual void SuckButtonPressed() { SuckButton.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
        public virtual void SuckButtonUp() { SuckButton.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
